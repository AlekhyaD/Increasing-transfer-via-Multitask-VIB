...
class BertForSequenceClassification(BertPreTrainedModel):
    ...
    def forward(
        ...
        if self.deterministic:
            ...
            final_outputs["z"] = mu
            sampled_logits, logits = self.get_logits(mu, mu, sampling_type='argmax',
                                                     dataset_name=kwargs["dataset_name"])  # always deterministic
...
optimizer_grouped_parameters = [
    ...
    {"params": [p for n, p in vibert_large_shared.named_parameters() if any(nd in n for nd in no_decay)],
     "weight_decay": 0.0},
]
...
for epoch in range(n_epochs):
    ...
    for labels, inp1, inp2, st in tqdm(train_dataloader):
        ...
        optimizer.zero_grad()
        batch = tokenizer(text=inp1, text_pair=inp2, max_length=128, truncation=True, padding=True,
                          add_special_tokens=True, is_split_into_words=False, return_tensors='pt')
        batch.to(device)
    ...
    print(
        "Epoch " + str(epoch) + " RTE Train Loss: " + str(total_train_loss_rte / c1_train) + " MRPC Train Loss: " + str(
            total_train_loss_mrpc / c2_train))
    print(" RTE Train Acc: " + str(total_train_acc_rte / c1_train) + " MRPC Train Acc: " + str(
        total_train_acc_mrpc / c2_train))
    ...
    print("Epoch " + str(epoch) + " RTE Val Loss: " + str(total_dev_loss_rte / c1_dev) + " MRPC Val Loss: " + str(
        total_dev_loss_mrpc / c2_dev))
...
print("Epoch " + str(epoch) + " RTE Test Loss: " + str(total_test_loss_rte / c1) + " MRPC Test Loss: " + str(
    total_test_loss_mrpc / c2))
